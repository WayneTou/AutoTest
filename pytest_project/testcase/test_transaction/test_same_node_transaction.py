...
class TestTransaction:
    ...
    def new_account(self):
        recieve_address = self.pt.w3.toChecksumAddress(self.pt.personal.newAccount('88888888'))
    ...
    def test_transaction(self):
        ...
        before_balance = self.pt.eth.getBalance(recieve_address)
        ...
        after_balance = self.pt.eth.getBalance(recieve_address)
